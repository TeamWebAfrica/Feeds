...
erpnext.PointOfSale.ItemSelector = class {
			...
			`<section class="items-selector">
				...
				<div style="padding:20px">
					...
					<div class="col-10"></div>
						<button type="button" class="btn btn-primary">New Formula</button>
						<button type="button" class="btn btn-primary">Edit Formula</button>
					<div class="col-1"></div>
				</div>
	...
	bind_events() {
		...
		this.$component.on('click', '.item-wrapper',async function() {
			console.log("Item clicked ................New file...")
			const $item = $(this);
